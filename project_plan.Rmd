...
# Introduction
<<<<<<< HEAD
Traumatic injury, the clinical entity composed of physical injury and the body's associated response <!-- Cite Martin? -->is a major cause of mortality and morbidity worldwide and the primary cause of death in young people [@Candef]. Traumatic injuries can be complex and require multidisciplinary treatment and rehabilitation, resulting in personal and societal costs and a significant public health burden globally [@Evans]. 
=======
...
Another significant factor in determining the outcome is the trauma treatment quality. Studies have shown a correlation between quality of trauma care and patient fatality, which have an inversely proportional relationship, showing the importance of optimizing treatment quality (). <!--True! Expand on this: trauma systems? -->
...
Cases with potential OFIs are typically selected by designated healthcare personnel, for the board to review. When an OFI is identified, new routine recommendations are set to improve general quality of care and prevent similar future outcomes. Common findings that may be identified are medication errors, failure to follow established protocols and shortage of healthcare personnel ().<!--True, but alos inital care and interventions: "Typically, OFIs identified often relate to initial care [@Vioque2014], specifically airway management, fluid resuscitation, hemorrhage control, and chest injury management [@Sanddal2011; @Roy2017; @OReilly2013]." 
...
# Methods
### Study design
<!-- I suggest that you use first person direct voice: "We conducted a ..."-->This is a registry-based study using trauma patients included in both the Karolinska University Hospital (KUH) trauma registry and Karolinska University Hospital trauma care quality database between 2017 and 2021. <!-- You can write that the trauma registry is part of SweTrau. JA: I would suggest reports to the Swedish trauma registry-->
...
KUH trauma registry includes information on all patients who were admitted with trauma team activation, regardless of the severity of their injuries, as well as patients who were admitted without trauma team activation but were later found to have a high level of injury (ISS greater than 9). 
...
Patients with missing data in any of the resuscitation procedures, such as intubation or blood transfusion will be excluded… <!-- You dont need to specify number of patients included at this stage, that is the first part of the results.  -->
